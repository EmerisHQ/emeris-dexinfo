  ...
  async realFetch(): Promise<void> {
    ...
    while (response.data.pagination.next_key != null) {
      response = await axios.get(
        this.endpoint + '/crescent/liquidity/v1beta1/pairs?pagination.key=' + response.data.pagination.next_key,
      );
    ...
    while (response.data.pagination.next_key != null) {
      response = await axios.get(
        this.endpoint + '/crescent/liquidity/v1beta1/pools?pagination.key=' + response.data.pagination.next_key,
      );
